...
#define DeviceName "CyberStickIV"
...
void sendDeviceInfo(IPAddress destinationAddress)
{
  ...
  strcpy(buffer, "devInfo CyberStickIV ");
...
void loop()
{
  ...
  if (configButton.wasDoubleKlicked())
  {
  ...
  {
    static int32_t oldp23=0;
    int32_t currentp23=digitalRead(23);
    if(currentp23!=oldp23)
    {
    Serial.println("port23 = " + String((int32_t)digitalRead(23)));
    oldp23 = currentp23;
    }
  }
  delay(100);
